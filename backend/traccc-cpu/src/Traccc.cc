    ...
    namespace backend
    {
        namespace Traccc
        {
            ...
            public:
                ...
                std::unique_ptr<TracccClusterStandalone> clusterStandalone;
            ...
            extern "C"
            {
                ...
                TRITONBACKEND_ModelInstanceInitialize(TRITONBACKEND_ModelInstance *instance)
                {
                    ...
                    instance_state->clusterStandalone = std::make_unique<TracccClusterStandalone>(instance_state->DeviceId());
                    return nullptr; // success
                }
            ...
            extern "C"
            {
                    ...
                    const uint32_t request_count)
                {
                    ...
                    std::vector<traccc::io::csv::cell> cells = instance_state->clusterStandalone->read_from_array(input_data_geoid, input_data_cells);
                    ...
                    // int numCells = input_tensor_values.size() /
                    // model_state->cellFeatures; Prepare the output. Originally it's a
